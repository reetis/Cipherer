...
public class Vignere extends FragmentActivity {

    private static final String TAG = Vignere.class.getSimpleName();
        ...
        switch(position) {
            case 0:
                getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.content_frame, TabbedFragment.newInstance(), "smth").commit();
                break;
        }
